    ...
    async getProduct(slug) {
      ...
      if (this.resp.success) {
        ...
        if (this.product.seo.description) {
          ...
          document.querySelector('meta[property="og:description"]').setAttribute("content", this.product.seo.description);
        }
      }
    },
    ...
    async getPage(slug) {
      ...
      if (this.resp.success) {
        ...
        if (this.content.seo.description) {
          ...
          document.querySelector('meta[property="og:description"]').setAttribute("content", this.content.seo.description);
        }
      }
    },
