<template>
  <div class="relative flex h-screen overflow-hidden">
    <div class="w-48 flex-none" id="menu">
      <div class="menu" id="menu">
        <div class="py-6">
          <router-link :to="{ name: 'products' }">
            <svg class="ml-6 h-8" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
    ...
    <div class="h-screen flex-1 overflow-y-auto px-5 pt-5">
      <slot />
    </div>
  </div>
</template>
...
.menu {
  ...
  & li {
    a {
      @apply flex items-center p-4 px-6 text-sm font-medium text-gray-900 hover:bg-gray-50 hover:text-gray-500;
    }
  }
